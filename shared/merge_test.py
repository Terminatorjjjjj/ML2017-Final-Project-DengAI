...
def main():
	...
	params_2 = {'data': sj_test,
				'pred': full_pred,
				'model_path': './rfr_models/sj_rfr_24-6971.pickle',
				'shift_week': 0,
				'lagging_week': 0}
	result_2 = make_prediction(**params_2)

	params_3 = {'data': sj_test,
				'pred': core_pred,
				'model_path': './rfr_models/15-sj_rfr.pickle',
				'shift_week': 0,
				'lagging_week': 4}
	result_3 = make_prediction(**params_3)

	# params_4 = {'data': sj_test,
	# 			'pred': full_pred + veg_pred,
	# 			'model_path': './rfr_models/12-sj_rfr.pickle',
	# 			'shift_week': 3,
	# 			'lagging_week': 0}
	# result_4 = make_prediction(**params_4)

	# params_5 = {'data': sj_test,
	# 			'pred': full_pred,
	# 			'model_path': './rfr_models/11-sj_rfr.pickle',
	# 			'shift_week': 0,
	# 			'lagging_week': 4}
	# result_5 = make_prediction(**params_5)

	# sj_result = (result_1 + result_2 + result_3 + result_4 + result_5) / 5
	sj_result = (result_1 + result_2 + result_3) / 3
	# sj_result = result_1
	...
	params_2 = {'data': iq_test,
				'pred': full_pred,
				'model_path': './rfr_models/iq_rfr_24-6971.pickle',
				'shift_week': 0,
				'lagging_week': 0}
	result_2 = make_prediction(**params_2)

	params_3 = {'data': iq_test,
				'pred': core_pred,
				'model_path': './rfr_models/15-iq_rfr.pickle',
				'shift_week': 0,
				'lagging_week': 4}
	result_3 = make_prediction(**params_3)

	# params_4 = {'data': iq_test,
	# 			'pred': full_pred + veg_pred,
	# 			'model_path': './rfr_models/12-iq_rfr.pickle',
	# 			'shift_week': 3,
	# 			'lagging_week': 0}
	# result_4 = make_prediction(**params_4)

	# params_5 = {'data': iq_test,
	# 			'pred': core_pred,
	# 			'model_path': './rfr_models/19-iq_rfr.pickle',
	# 			'shift_week': 0,
	# 			'lagging_week': 15}
	# result_5 = make_prediction(**params_5)

	# iq_result = (result_1 + result_2 + result_3 + result_4 + result_5) / 5
	iq_result = (result_1 + result_2 + result_3) / 3
	# iq_result = result_1
